...
let txtConferma = `Vuoi procedere con gli acquisti? Premi il tasto "TAB" e digita "SI/NO", poi premi il tasto "INVIO"`;
let txtSeiSicuro = `Sei sicuro? Premi il tasto "TAB" e digita "CERTO/NON NE SONO SICURO", poi premi il tasto "INVIO"`;
